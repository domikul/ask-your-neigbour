...
import pl.polsl.AskYourNeighbor.constant.ResourceUrl;
...
class AdminAccountControllerTest {
    ...
    void getAccountById_existingId() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(ResourceUrl.ACCOUNT + "/" + savedRecord.getId()))
    ...
    void getFormById_wrongId() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(ResourceUrl.ACCOUNT + "/99999"))
    ...
    void getAccounts() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(ResourceUrl.ACCOUNT))
                .andExpect(status().is(200))
                .andExpect(MockMvcResultMatchers.jsonPath("$").isNotEmpty())
    ...
    void createNewAccount() throws Exception {
        ...
        MvcResult result = this.mockMvc
                .perform(MockMvcRequestBuilders.post(ResourceUrl.ACCOUNT)
    ...
    void deleteAccountById() throws Exception {
        ...
        MvcResult result = this.mockMvc
                .perform(MockMvcRequestBuilders.delete(ResourceUrl.ACCOUNT + "/" + savedAccount.getId()))
